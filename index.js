...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("Ag0D3IAAntIBpAAIg1Htg");
	this.shape.setTransform(364.975,24.675);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("");
	this.shape_1.setTransform(185.9,25.325);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("A7QD3IAAntMA2hAAAIAAHtg");
	this.shape_2.setTransform(185.15,24.675);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("Ag0D3IA0ntIA1AAIAAHtg");
	this.shape_3.setTransform(5.325,24.675);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.tx3, new cjs.Rectangle(0,0,370.3,49.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,523);
...
}).prototype = getMCSymbolPrototype(lib.snow2_1, new cjs.Rectangle(0,0,1700,1023), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(0,501);
...
if (reversed == null) { reversed = false; }
	...
	this.sn2.name = "sn2";
	this.sn2.setTransform(62,0,1,1,0,0,0,850,250);
...
}).prototype = getMCSymbolPrototype(lib.snow, new cjs.Rectangle(-850,-250,1762,1023), null);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		tl
			.staggerFrom(StagS1, 0.8, {y:"-=30", ease:"Power3.easeOut"}, 0.2, "0")
			.staggerFrom(StagP1, 0.8, {y:"+=50", ease:"Power3.easeOut"}, 0.2, "0")
		
			.staggerFrom(StagS2, 0.8, {y:"-=30", ease:"Power3.easeOut"}, 0.2, "0.2")
			.staggerFrom(StagP2, 0.8, {y:"+=50", ease:"Power3.easeOut"}, 0.2, "0.2")
			
			.from(root.but_new, 1.3, {scaleX:4, scaleY:4, ease:"Elastic.easeOut"}, "0.9")
			.from(root.but_new, 0.1, {alpha:0, ease:"Elastic.easeOut"}, "0.9")
		
			.to(root.snow.sn1, 5, {y:"+=200", x:"+=50", ease:"none"}, "0")
			.to(root.snow.sn2, 7, {y:"+=200",  ease:"none"}, "0")
			.to(root.bg_picgray, 1.5, {alpha:0, ease:"Power2.easeOut"}, "0.5")
		
		
		
			.from(root.cr.cr2, 0.6, {y:"-=400", x:"+=280", ease:"Power2.easeInOut"}, "3")
			.from(root.cr.cr3, 0.6, {y:"+=500", x:"-=270", ease:"Power2.easeInOut"}, "3")
		
		
			.from(root.disc_b, 0.3, {alpha:0, ease:"Power3.easeOut"}, "3.5")	
			.from(root.tx1_end, 1, {y:"-=170", ease:"Bounce.easeOut"}, "3.5")	
			.from(root.tx3, 1, {y:"-=170", ease:"Bounce.easeOut"}, "3.8")
		
		
		
			.from(root.bgy, 0.1, {alpha:0}, "4")
			.to(root.cr, 0.1, {alpha:0}, "5")
			.to(root.tx1, 0.1, {alpha:0}, "5")
			.to(root.tx2, 0.1, {alpha:0}, "5")
			.to(root.but_new, 0.1, {alpha:0}, "5")
			.from(root.bg_picgray2, 0.1, {alpha:0}, "5")
		
			.to(root.disc_b, 0.3, {alpha:0, ease:"Power3.easeOut"}, "8")	
			.to(root.logo, 0.3, {alpha:0, ease:"Power3.easeOut"}, "8")	
			.to(root.tx3, 0.3, {alpha:0, ease:"Power3.easeOut"}, "8")	
			.to(root.tx1_end, 0.3, {alpha:0, ease:"Power3.easeOut"}, "8")	
			.to(root.cr, 0.3, {alpha:0, ease:"Power3.easeOut"}, "8.3")	
	...
	this.tx3.name = "tx3";
	this.tx3.setTransform(1127.2,89.25,1,1,0,0,0,185.2,24.7);
